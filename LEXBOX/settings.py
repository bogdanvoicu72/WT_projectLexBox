"""
Django settings for LEXBOX project.
...
SECRET_KEY = 'f+hou)$@mhde-0!)*f&e!f)17a*2e-168vu$b566b0%fypfe8s'
...
WSGI_APPLICATION = 'LEXBOX.wsgi.application'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'lexboxsimulator@gmail.com'
