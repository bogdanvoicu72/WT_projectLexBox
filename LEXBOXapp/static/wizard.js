...
WizardDemo = function () {
    ...
    return {
        init: function () {
            var r;
            $("#m_wizard"), n = $("#m_form"), (e = new mWizard("m_wizard", {startStep: 1})).on("beforeNext", function (e) {
                !0 !== i.form() && e.stop()
                ...
                messages: {
                    ...
                    accept: {required: "Trebuie sa cititi regulile de utilizare ale aplicatiei!"}
                },
                invalidHandler: function (e, r) {
                    mApp.scrollTop(), swal({
                        title: "",
                        text: "Nu ati completat toate campurile necesare",
                        type: "error",
                ...
                e.preventDefault(), i.form() && (mApp.progress(r), n.ajaxSubmit({
                    success: function () {
                        mApp.unprogress(r), swal({
                            title: "",
                            text: "Cererea dumneavoastra a fost inregistrata!",
                            type: "success",
                            confirmButtonClass: "btn btn-secondary m-btn m-btn--wide"
                        })
                    }
